...
class UserRepository(DictRepository):
    ...
    def clear_force_password_change(self, username: str) -> bool:
        """
        Quita el flag force_password_change de un usuario.
        ...
        Returns:
            True si se actualizó
        """
        return self.update_user(username, {'force_password_change': False})
    
    def set_force_password_change(self, username: str, value: bool = True) -> bool:
        """
        Establece el flag force_password_change de un usuario.
        
        Args:
            username: Nombre de usuario
            value: Valor del flag (default True)
            
        Returns:
            True si se actualizó
        """
        return self.update_user(username, {'force_password_change': value})
